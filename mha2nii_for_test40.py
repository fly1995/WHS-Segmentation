...
if __name__ == '__main__':
    ...
    input_folder = r'E:\D6_MMWHS_2017\MedicalDataAugmentationTool-MMWHS\inference\Proposed_wo_lab\MR\iter_0/' #UNet  CT  MR
    ...
    reference_folder = 'mmwhs_dataset/ct_test40_nii/' if is_ct else 'mmwhs_dataset/mr_test40_nii/'

    output_folder = 'E:/D6_MMWHS_2017/TestReults40/Proposed_wo_lab/CT/' if is_ct else 'E:/D6_MMWHS_2017/TestReults40/Proposed_wo_lab/MR/' #MM_WHS_GUT， MM_WHS_UNet
    ...
    for filename in sorted(filenames):
        ...
        relabel(reoriented)
        itk.imwrite(reoriented, os.path.join(output_folder, basename_wo_ext + '_label.nii.gz'))#_label.nii.gz 测试40个病例将文件名改成这个,在matlab里面测试需要文件名一致
